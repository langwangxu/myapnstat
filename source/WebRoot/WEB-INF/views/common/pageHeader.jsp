    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-inverse" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<a href="<c:url value='/'/>" class="navbar-brand"><i class="fa fa-flag myi fa-red"></i>翠雅咖啡厅管理信息系统</a>
			</div>
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<li class="active"><a href="<c:url value='/'/>">首页</a></li>
					<li><a href="<c:url value='/vip/list'/>">VIP列表</a></li>
					<li><a href="<c:url value='/acc/list'/>">VIP用餐登记信息</a></li>
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">APN统计功能<span class="caret"></span></a>
